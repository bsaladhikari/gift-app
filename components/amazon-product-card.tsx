...
import { ExternalLink, Star, Heart, Bookmark, Check, ShoppingCart, Truck } from "lucide-react"
    ...
    <div className="group relative bg-white/70 backdrop-blur-2xl rounded-[2rem] p-6 shadow-3xl border border-white/50 hover:shadow-4xl transition-all duration-500 hover:scale-105">
      ...
      {product.isPrime && (
        <div className="absolute top-6 left-6 z-10">
          <div className="px-3 py-1 bg-blue-600 text-white rounded-full text-xs font-bold flex items-center space-x-1">
      ...
      {/* Product Image */}
      <div className="relative mb-6 group/image pt-12">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          {product.isPrime && (
            <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">Free Shipping</span>
          )}
        </div>
        ...
        <div className="flex space-x-3 pt-4">
          ...
          <a
            ...
            className="flex-1 flex items-center justify-center space-x-2 py-3 px-4 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-xl transition-all duration-300 text-sm font-medium shadow-lg hover:shadow-xl transform hover:scale-105"
          >
